...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        // Read the total number of stops
        ...
        for (int i = 0; i < n; i++) {
            ...
            int exiting = Integer.parseInt(st.nextToken());
            int entering = Integer.parseInt(st.nextToken());
            
            // Update the current number of people in the tram
            currentPassengers = currentPassengers - exiting + entering;
            
            // Track the maximum capacity required at any point
            if (currentPassengers > maxCapacity) {
                maxCapacity = currentPassengers;
            }
        }
        
        // Print the minimum possible capacity needed
